...
class App:
    ...
    def verificar(self):
        ...
        if(usu == "root" and password == "1234") :
            ...
            messagebox.showerror(message="La contraseña no es la correcta", title="Mensaje")
    ...
    def __init__(self): 
        ...
        # frame_logo
        frame_logo = tk.Frame(self.ventana, bd=0, width=300, relief=tk.SOLID, padx=10, pady=10,bg='#2858ac')
        frame_logo.pack(side="left",expand=tk.NO,fill=tk.BOTH)
        label = tk.Label(frame_logo, image=logo,bg='#2858ac')
        ...
        inicio = tk.Button(frame_form_fill, text="Iniciar sesion", font=('Times', 15, BOLD),bg='#fff', bd=0, fg="#033942", command=self.verificar)
